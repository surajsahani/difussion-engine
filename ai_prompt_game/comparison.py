...
try:
    ...
    PIL_AVAILABLE = False
    print("⚠️  PIL not available, LLaVA functionality will be limited")

class ImageComparison:
    """Handles image similarity comparison using multiple metrics including LLaVA"""
    
    def __init__(self, use_llava=True):
        self.weights = {
    ...
    def llava_similarity(self, generated_image, target_image):
        ...
        if not PIL_AVAILABLE:
            return 0.5, "PIL not available for LLaVA processing"
